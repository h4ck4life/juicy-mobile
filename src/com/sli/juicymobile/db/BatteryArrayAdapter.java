...
public class BatteryArrayAdapter extends ArrayAdapter<Battery> {
	...
	public static Battery[] batteries = {
			...
			// Orbtronic
			new Battery("Orbtronic", "IMR", "CGR18650CH", "18650", 2250, 10,
					0.5f),
			new Battery("Orbtronic", "IMR", "18650 PD2900", "18650", 2900, 10,
					0.5f),
			new Battery("Orbtronic", "IMR", "18650 SX22", "18650", 2000, 22,
					0.25f),
			new Battery("Orbtronic", "IMR", "18650 SX30", "18650", 2100, 30,
					0.2f),
			new Battery("Orbtronic", "Li", "", "18650", 3600, 5, 1.0f),
			new Battery("Orbtronic", "Li", "NCR18650A", "18650", 3100, 6.2f,
					0.8f),

			// Panasonic
			new Battery("Panasonic", "IMR", "CGR18650CH", "18650", 2250, 10,
					0.5f),
			new Battery("Panasonic", "IMR", "NCR18650PF", "18650", 2900, 10,
					0.5f),
			new Battery("Panasonic", "IMR", "NCR18650PD", "18650", 2900, 10,
					0.5f),
			new Battery("Panasonic", "Li", "NCR18650A", "18650", 3100, 6.2f,
					0.8f),
			new Battery("Panasonic", "Li", "NCR18650B", "18650", 3400, 6.8f,
					0.75f),

			// Samsung
			new Battery("Samsung", "IMR", "INR18650-20R", "18650", 2000, 22,
					0.25f),
